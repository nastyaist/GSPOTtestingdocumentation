### Payments
#### Payment_accounts_owner_negative_input_special_characters_frozen_time_PATCH
...
5. Ввести спецсимволы в поле "frozen_time" (пример "@#$%^")
...
|     ---     |  ---  |    ---    |   ---  |    ---     |
|  2023-07-23 | 12:41 |   Passed  | Василий|     -      | 